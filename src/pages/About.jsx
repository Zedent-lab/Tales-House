...
const Userprofile = () => {
  ...
  const BookingCard = ({ booking }) => (
    <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300">
      <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
        <img 
          src={booking.image} 
          alt={booking.title}
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
        ...
        return userData ? (
          <div className="space-y-8">
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-700/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    value={userData.name}
                    className="w-full px-4 py-2 sm:py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 sm:py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent">
              ...
              <button className="mt-6 w-full sm:w-auto px-6 py-2 sm:py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300">
                Update Profile
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50">
              ...
              <div className="border-t border-gray-600 pt-4">
                ...
                <button
                  className="w-full py-2 sm:py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300"
      ...
      case 'bookings':
        return (
          <div className="space-y-6">
            <h2 className="text-xl sm:text-2xl font-bold text-white">My Bookings</h2>
            <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {purchaseHistory.map(purchase => (
                <div key={purchase.id} className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50">
                  <div className="flex justify-between items-center">
                    <div>
